...
2. Produce or update a cross‑repo plan in `PRCR-1063-PLAN.md` at the root of this repo.
3. Keep `PRCR-1063-contracts.md` (or create it if missing) as the single source of truth for API contracts, DTOs, and data shapes shared between frontend and backend.

**Definition of done**:

- `PRCR-1063-PLAN.md` exists and contains:
  - Problem statement.
...
- `PRCR-1063-contracts.md` is created/updated with any new or changed request/response shapes, validation rules, and error formats.
...
- Do not modify application code in this role; only edit `PRCR-1063-PLAN.md` and `PRCR-1063-contracts.md`.

Now:

1. Ask me any clarifying questions you need.
2. Propose the initial `PRCR-1063-PLAN.md` and `PRCR-1063-contracts.md` edits.
