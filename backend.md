...
- Treat `PRCR-1260-v2-PLAN.md` and `PRCR-1260-v2-contracts.md` at the repo root as the source of truth.
...
1. Implement or adjust endpoints, services, and modules for `[BACKEND_DB]` steps in `PRCR-1260-v2-PLAN.md`.
2. Keep DTOs and validation in sync with `PRCR-1260-v2-contracts.md`. If you adjust contracts, update `PRCR-1260-v2-contracts.md` and highlight the change.
...
- Any contract changes reflected in `PRCR-1260-v2-contracts.md` with a short “Changelog” section.
...
For this run, focus ONLY on these `[BACKEND_DB]` items from `PRCR-1260-v2-PLAN.md`:
