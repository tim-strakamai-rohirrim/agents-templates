...
- `PRCR-1063-PLAN.md` for the original problem, scope, and checklist.
- `PRCR-1063-contracts.md` for API/data contracts and notable changes.
...
- Contracts:
  - [Changes in request/response shapes, validation rules, error formats from `PRCR-1063-contracts.md`]
...
- It does not mention `PRCR-1063-PLAN.md` or `PRCR-1063-contracts.md` or "phases" because those files are not tracked in Git.
