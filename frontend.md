...
- Treat `PRCR-1260-v2-PLAN.md` and `PRCR-1260-v2-contracts.md` at the repo root as the source of truth for the current feature or bugfix.
...
1. Implement only the steps marked `[FRONTEND]` in `PRCR-1260-v2-PLAN.md` that I specify (never “do the whole plan”).
2. Keep UI code aligned with the API contracts in `PRCR-1260-v2-contracts.md`.
...
For this run, focus ONLY on the following plan items from `PRCR-1260-v2-PLAN.md`:
